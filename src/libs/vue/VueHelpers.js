...
const editor = (content, options) =>
  Handlebars.helpers.editor(content, { hash: options });
 ...
 */
const ifThen = (criteria, ifTrue, ifFalse) =>
  Handlebars.helpers.ifThen(criteria, ifTrue, ifFalse);
 ...
 */
const localize = (value, data = {}) =>
  Handlebars.helpers.localize(value, { hash: data });
...
const numberFormat = (value, options) =>
  Handlebars.helpers.numberFormat(value, { hash: options });
 ...
 */
const numberInput = (value, options) =>
  Handlebars.helpers.numberInput(value, { hash: options });
 ...
 * @returns {Handlebars.SafeString}
 */
const radioBoxes = (name, choices, options) =>
  Handlebars.helpers.radioBoxes(name, choices, { hash: options });
...
const rangePicker = options =>
  Handlebars.helpers.rangePicker({ hash: options });
 ...
 */
const selectOptions = (choices, options) =>
  Handlebars.helpers.selectOptions(choices, { hash: options });
